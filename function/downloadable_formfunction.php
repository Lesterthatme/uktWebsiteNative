...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_form"])) {
    ...
    if ($count > 0) {
        ...
        header("Location: ../pages/adminukt/downloadable_forms");
        exit();
    }
...
// START >> ADD FORM  ADD FORM for content manager
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["add_cmform"])) {
    $form_name = trim($_POST["form_name"]);
    $form_description = $_POST["form_description"];
    $ap_id = $_POST["ap_id"];
...
// END >> ADD FORM for content manager
