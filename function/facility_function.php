...
if (isset($_POST['add_facility'])) {
    ...
    if (mysqli_query($conn, $insertQuery)) {
        ...
        header("Location: ../pages/adminukt/facilities?department_id=$department_id#facility");
        exit();
    } else {
...
if (isset($_GET['facility_id']) && is_numeric($_GET['facility_id'])) {
    ...
    if (!$user_id) {
        ...
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../pages/adminukt/facilities");
        exit;
    }
    ...
    header("Location: ../pages/adminukt/facilities?department_id=" . $facility_data['department_id'] . "#facility");
    exit;
}
