...
if (isset($_POST['add_research'])) {
    ...
    if (!isset($_SESSION['ap_id'])) {
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            $_SESSION['toastType'] = "toast-error";
            header("Location: ../pages/adminukt/University_Library_Research_Projects");
            exit();
        }
    } else {
...
if (isset($_GET['delete_id'])) {
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        header("Location: ../pages/adminukt/University_Library_Research_Projects?message=not_found");
        exit();
    }
