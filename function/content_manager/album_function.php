...
if (isset($_POST["add_album"])) { 
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Album and images added successfully!'); window.location.href='../../pages/content_manager/university_album';</script>";
    } else {
...
if (isset($_POST['update_album'])) {
    ...
    if (mysqli_query($conn, $query)) {
        ...
        echo "<script>
                ...
                window.location.href = '../../pages/content_manager/university_album';
              </script>";
    } else {
        ...
        foreach ($_FILES['images']['name'] as $key => $image_name) {
            ...
            if (move_uploaded_file($tmp_name, $image_folder . $new_image_name)) {
                ...
                if ($stmt->execute()) {
                    ...
                    echo "<script>alert('Images uploaded successfully.'); window.location.href='../../pages/content_manager/view_album?album_id=$album_id';</script>";
                } else {
