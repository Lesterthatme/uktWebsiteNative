    ...
    if (!empty($reply_message)) {
        ...
        if ($stmt->execute()) {
            ...
            try {
                ...
                if ($mail->send()) {
                    echo "<script>alert('Reply sent successfully!'); window.location.href='../../pages/content_manager/view_message?message_id=$message_id';</script>";
                } else {
                    echo "<script>alert('Reply saved but email sending failed.'); window.location.href='../../pages/content_manager/view_message?message_id=$message_id';</script>";
                }
            } catch (Exception $e) {
                echo "<script>alert('Reply saved but email error: {$mail->ErrorInfo}'); window.location.href='../../pages/content_manager/view_message?message_id=$message_id';</script>";
            }
        } else {
