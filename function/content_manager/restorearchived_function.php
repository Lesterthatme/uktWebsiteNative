...
if (!isset($_SESSION['user_id'])) {
    ...
    header("Location: ../../pages/content_manager/login");
    exit();
}
...
if (isset($_GET['restorehighlight_id'])) {
    ...
    if (!$stmt) {
        ...
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive");
        exit();
    }
    ...
    if ($archive) {
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['toastMsg'] = "Highlights restored successfully!";
            $_SESSION['toastType'] = "toast-success";
        } else {
            $_SESSION['toastMsg'] = "Failed to restore highlights: " . $stmt->error;
            $_SESSION['toastType'] = "toast-error";
        }
    } else {
...
if (isset($_GET['deletehighlight_id'])) {
    $record_id = intval($_GET['deletehighlight_id']); 
    ...
    if ($stmt->execute()) {
        $logDescription = "Permanent deleted the highlight: '$message_subject'";
        $logDate = date("Y-m-d"); 
        $logTime = date("H:i:s"); 
        ...
        $_SESSION['toastMsg'] = "Highlight permanently deleted!";
        $_SESSION['toastType'] = "toast-success";
    } else {
...
//restoring and permanent delete highlights function end
...
if (isset($_GET['restorepartnership_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_partnership");
        exit();
    }
    ...
    if ($archive) {
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['toastMsg'] = "Failed to University Partnership: " . $stmt->error;
            $_SESSION['toastType'] = "toast-error";
        }
    } else {
...
if (isset($_GET['deletepartnership_id'])) {
    ...
    if ($stmt->execute()) {
        // Insert into history_log table
        $logDescription = "Permanent delete the Universtiy Partnership: '$up_name'";
        $logDate = date("Y-m-d"); 
        $logTime = date("H:i:s"); 
...
if (isset($_GET['restoreevent_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_calendar");
        exit();
    }
    ...
    if ($archive) {
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['toastMsg'] = "Event restored successfully!";
            $_SESSION['toastType'] = "toast-success";
        } else {
            $_SESSION['toastMsg'] = "Failed to restore event: " . $stmt->error;
            $_SESSION['toastType'] = "toast-error";
        }
    } else {
        $_SESSION['toastMsg'] = "Event not found in archive.";
        $_SESSION['toastType'] = "toast-error";
    }
...
if (isset($_GET['restorefaq_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_faq");
        exit();
    }
...
if (isset($_GET['restoreannouncement_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_announcement");
        exit();
    }
...
if (isset($_GET['restoremessage_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_message");
        exit();
    }
...
if (isset($_GET['deletemessage_id'])) {
    $record_id = intval($_GET['deletemessage_id']); 
    ...
    $message_subject = "Unknown Subject"; 
    if ($archive) {
        $archive_description = json_decode($archive['archive_description'], true);
...
if (isset($_GET['restoregallery_id']) && isset($_GET['item_type'])) {
    ...
    header("Location: ../../pages/content_manager/archive_album");
    exit;
}
...
if (isset($_GET['restorenews_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_news");
        exit();
    }
...
if (isset($_GET['restoreposter_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_poster");
        exit();
    }
...
if (isset($_GET['restorerequirement_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_admissionrequirements");
        exit();
    }
...
// Permanent Delete ADMISSION REQUIREMENTS Function
...
if (isset($_GET['restorescholarship_id'])) {
    ...
    if (!$stmt) {
        $_SESSION['toastMsg'] = "Database error: " . $conn->error;
        $_SESSION['toastType'] = "toast-error";
        header("Location: ../../pages/content_manager/archive_scholarship");
        exit();
    }
