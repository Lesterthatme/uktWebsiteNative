...
// update core function start
if (isset($_POST['update_core'])) {
    $university_core = mysqli_real_escape_string($conn, $_POST['university_core']);
    $user_id = $_SESSION['user_id'];

    $query = "UPDATE university_vmgo SET university_core = '$university_core' WHERE vmgo_id = 1";
