                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../../function/founder_function.php" method="POST"
                                        ...
                                        <div class="management_card">
                                            ...
                                            <div class="dropdown three-dots">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <form method="POST" action="../../function/founder_function.php" style="display:inline;">
                                        ...
                                        <div class="modal fade" id="editModal<?= $row['founder_id']; ?>" tabindex="-1">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="../../function/founder_function.php" enctype="multipart/form-data">
                                                            <input type="hidden" name="founder_id" value="<?= $row['founder_id']; ?>">
