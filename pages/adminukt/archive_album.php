                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item text-dark" 
                                                                        href="../../function/restorearchived_function.php?restoregallery_id=' . $row['id'] . '&item_type=' . $row['item_type'] . '" 
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item text-dark" 
                                                                        href="../../function/restorearchived_function.php?deletegallery_id=' . $row['id'] . '&item_type=' . $row['item_type'] . '" 
