                  ...
                  <div class="modal-body">
                    <form action="../../function/libraryupdates_function.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="modal-footer">
                        <button type="submit" name="add_update" class="btn btn-dynamic"> Save</button>
                      </div>
                    </form>
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        $update_image = $row['update_image'] ? "../librarian/assets/uploads/Libraryupdate_images/" . $row['update_image'] : "../assets/uploads/Libraryupdate_images/profile (1).png";
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form id="editForm" method="POST" action="../../function/libraryupdates_function.php"
                        ...
                        <div class="modal-footer">
                          <button type="submit" name="update" class="btn btn-dynamic"><i class="ri-save-fill"></i>
                            Save</button>
                        </div>
                      </form>
                    </div>
