...
<body class="bg-light">
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form method="POST" action="../../function/news_function.php" enctype="multipart/form-data">
                      <div class="mb-3">
                      ...
                      ?>
                        <div class="card news-card" style="width: 22rem;">
                          ...
                          <div class="card-body d-flex flex-column">
                            ...
                            <h5 class="card-title text-center fw-semibold text-muted"><?= $news_title; ?></h5>
                            <p class="card-text text-muted text-justify fw-thin text-center"><?= $news_description; ?></p>
  ...
  <script src="../../assets/bootstrap/js/site_settings.js?v=1.5"></script>
