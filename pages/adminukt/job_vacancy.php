...
<body class="bg-light">
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../../function/jobvacancy_function.php" method="POST" enctype="multipart/form-data">
                                            <div class="row">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                ...
                                                                <li>
                                                                    <form action="../../function/jobvacancy_function.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this job vacancy?')">
                                                ...
                                                <div class="modal fade" id="editModal<?= $row['vacancy_id']; ?>" tabindex="-1" aria-labelledby="editModalLabel<?= $row['vacancy_id']; ?>" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form id="editForm<?= $row['vacancy_id']; ?>" action="../../function/jobvacancy_function.php" method="POST" enctype="multipart/form-data">
                                                                    <input type="hidden" name="vacancy_id" value="<?= $row['vacancy_id']; ?>">
    ...
    <script src="../../assets/bootstrap/js/script.js?v=1.1"></script>
