                  ...
                  <div class="modal-body">
                    <form action="../../function/libraryresources_function.php" method="POST">
                      ...
                      <div class="modal-footer">
                        <button type="submit" class="btn btn-dynamic" name="add_resource"><i class="ri-save-fill"></i> Save
                        </button>
                      </div>
                    </form>
                  </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="../../function/libraryresources_function.php" method="POST">
                        ...
                        <div class="modal-footer">
                          <button type="submit" class="btn btn-dynamic" name="update_resource"><i class="ri-save-fill"></i> Save</button>
                        </div>
                      </form>
