                                        ...
                                        <ul class='dropdown-menu'>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/restorearchived_function.php?restorescholarship_id=" . $row['record_id'] . "' 
                                            ...
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/restorearchived_function.php?deletescholarship_id=" . $row['record_id'] . "' 
