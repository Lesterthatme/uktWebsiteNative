          ...
          <div class="card-body">
            <div class="doc-tabs-container mt-3">
              <ul class="doc-tabs d-flex list-unstyled">
                <li class="me-3">
                  <a class="doc-link active" href="Board_of_Directors">Active</a>
                </li>
                <li class="me-3">
                  <a class="doc-link" href="inactiveBoard_of_Directors">Inactive</a>
                </li>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body pb-0">
                    <form action="../../function/boardofdirector_function.php" method="POST"
                  ...
                  <div class="management_card">
                    <div class="dropdown three-dots">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                          <a class="dropdown-item edit-btn fw-normal text-dark" href="#" data-bs-toggle="modal" data-bs-target="#editModal"
                    ...
                    <div class="management-status-active <?php echo ($row['status'] == 'Inactive') ? 'announcement-status-inactive' : ''; ?>">
