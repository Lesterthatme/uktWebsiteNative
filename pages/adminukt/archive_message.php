          ...
          <div class="card-body">
            ...
            <div class="log_container mt-3">
              ...
              $query =  "SELECT 
                          ...
                          record_id, 
                          archived_at, 
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.message_subject')) AS message_subject,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.message_body')) AS message_body,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.sender_email')) AS sender_email,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.sender_fname')) AS sender_fname,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.sender_mname')) AS sender_mname,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.sender_lname')) AS sender_lname,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.date_sent')) AS date_sent
                      FROM university_archive
                      WHERE original_table = 'university_message'
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        ...
                        $full_name = trim($row['sender_fname'] . ' ' . ($row['sender_mname'] ? $row['sender_mname'] . ' ' : '') . $row['sender_lname']);

                        echo "<tr>
                    <td>" . htmlspecialchars($row['message_subject']) . "</td>
                    ...
                    <td>
                            ...
                            <ul class='dropdown-menu'>
                                <li>
                                    <a class='dropdown-item text-dark' 
                                        href='../../function/restorearchived_function.php?restoremessage_id=" . $row['record_id'] . "' 
                                        onclick='return confirm(\"Do you want to restore this message?\")' 
                                        data-bs-toggle='tooltip' 
                                        data-bs-placement='right' 
                                        title='Click here to restore the message'>
                                 ...
                                 <li>
                                    <a class='dropdown-item text-danger' 
                                        href='../../function/restorearchived_function.php?deletemessage_id=" . $row['record_id'] . "' 
                                        onclick='return confirm(\"Do you want to delete this message?\")' 
                                        data-bs-toggle='tooltip' 
                                        data-bs-placement='right' 
                                        title='Click here to permanent delete the message'>
                      ...
                      echo "<tr><td colspan='7'>No archived message available</td></tr>";
                    }
                    ?>
                  </tbody>
                </table>
