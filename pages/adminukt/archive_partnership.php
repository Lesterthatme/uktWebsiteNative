                                        ...
                                        <ul class='dropdown-menu'>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/restorearchived_function.php?restorepartnership_id=" . $row['record_id'] . "' 
                                            ...
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/restorearchived_function.php?deletepartnership_id=" . $row['record_id'] . "' 
