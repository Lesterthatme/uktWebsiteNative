                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="../../function/libraryresearch_function.php" method="POST">
                      ...
                      <div class="mb-3">
                        <label for="researchers" class="form-label fw-semibold text-muted"><strong>Researcher/s
                            Name:</strong></label>
                        <textarea class="form-control" id="researchers" name="researchers"
                          placeholder="Enter Researcher/s Name" rows="3" required></textarea>
                      </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form action="../../function/libraryresearch_function.php" method="POST">
                        ...
                        <div class="mb-3">
                          <label class="form-label fw-semibold text-muted">Researcher/s Name</label>
                    ...
                    <div class="modal-footer">
                      <button type="submit" name="update_research" class="btn btn-dynamic"><i class="ri-save-fill"></i>
                        Save</button>
                    </div>
                    </form>
                      ...
                      <div class="row d-flex justify-content-center">
                        <div class="col-md-12">
                          <div class="row">
                            ...
                            <p><strong>Researcher/s Name:</strong> <span id="modalResearcher"></span></p>
