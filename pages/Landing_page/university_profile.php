                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12">
                            ...
                            <div class="info_list mx-auto" style="max-width: 600px;">
                                ...
                                // Define info items
                                $infoItems = [
                                    ['ri-user-line', 'សាកលវិទ្យាធិការ', $university['university_president']],
                                    [
                                        'ri-map-pin-line',
                                        'អាសយដ្ឋាន',
                                    ...
                                    ['ri-map-pin-line', 'លេខកូដប្រៃសណីយ៍', $university['university_postalcode']],
                                    ['ri-mail-line', 'អ៊ីមែល', $university['university_emailaddress']],
                                    ['ri-phone-line', 'ទូរស័ព្ទ', $university['university_contactnumber']],
                                    ['ri-global-line', 'គេហទំព័រ', '<a href="' . htmlspecialchars($university['university_website']) . '" target="_blank">' . htmlspecialchars($university['university_website']) . '</a>'],
                                    ['ri-facebook-circle-line', 'ហ្វេសប៊ុក', '<a href="' . htmlspecialchars($university['fb_link']) . '" target="_blank">' . htmlspecialchars($university['fb_link']) . '</a>'],
                                    ['ri-youtube-fill', 'យូធូប', '<a href="' . htmlspecialchars($university['youtube_link']) . '" target="_blank">' . htmlspecialchars($university['youtube_link']) . '</a>'],
                                    ['ri-calendar-line', 'ឆ្នាំបង្កើត', $university['university_yearestablished']],
                                ];
