                    ...
                    <div class="card-body">
                        <div class="doc-tabs-container mt-3">
                            <ul class="doc-tabs d-flex list-unstyled">
                                <li class="me-3">
                                    <a class="doc-link" href="rector_page">Active</a>
                                </li>
                                <li class="me-3">
                                    <a class="doc-link active" href="inactiverector">Inactive</a>
                                </li>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../../function/content_manager/rector_function.php" method="POST"
                        ...
                        // Fetch Rectors data
                        $sql = "SELECT * FROM rector WHERE status ='Inactive'";
                        $result = $conn->query($sql);
                        ?>
                            ...
                            <div class="carousel-inner p-4">
                                ...
                                ?>
                                        <div class="management_card">
                                            ...
                                            <div
                                                class="management-status-inactive <?php echo ($row['status'] == 'Inactive') ? 'management-status-inactive' : ''; ?>">
                                        ...
                                        <div class="modal fade" id="editModal<?php echo $row['rector_id']; ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form method="POST" action="../../function/content_manager/rector_function.php" enctype="multipart/form-data">
