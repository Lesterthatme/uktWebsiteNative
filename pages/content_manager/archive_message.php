                            ...
                            <ul class='dropdown-menu'>
                                <li>
                                    <a class='dropdown-item text-dark' 
                                        href='../../function/content_manager/restorearchived_function.php?restoremessage_id=" . $row['record_id'] . "' 
                                 ...
                                 <li>
                                    <a class='dropdown-item text-dark' 
                                        href='../../function/content_manager/restorearchived_function.php?deletemessage_id=" . $row['record_id'] . "' 
