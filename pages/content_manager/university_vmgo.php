              ...
              <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-body pb-0">
                    <form method="POST" action="../../function/content_manager/vmgo_function.php" role="dialog">
            ...
            <div class="modal fade" id="vision" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-body pb-0">
                    <form action="../../function/content_manager/vmgo_function.php" method="POST" role="dialog">
                      <input type="hidden" name="vmgo_id" id="vmgo_id" value="<?php echo $vmgo_id; ?>">
                      <div class="row mb-3">
