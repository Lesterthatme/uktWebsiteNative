...
<body class="bg-light">
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="../../function/content_manager/event_calendar.php" method="POST">
                      <div class="mb-3">
  ...
  <script>
    function loadEditEvent(uc_id) {
      ...
      $.ajax({
        url: '../../function/content_manager/fetch_event_details.php', // Backend file to fetch event details
        method: 'GET',
        data: {
          uc_id: uc_id
        },
