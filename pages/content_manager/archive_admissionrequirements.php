                                        ...
                                        <ul class='dropdown-menu'>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/content_manager/restorearchived_function.php?restorerequirement_id=" . $row['record_id'] . "' 
                                            ...
                                            <li>
                                                <a class='dropdown-item text-danger' 
                                                    href='../../function/content_manager/restorearchived_function.php?deleteadrequirement_id=" . $row['record_id'] . "' 
