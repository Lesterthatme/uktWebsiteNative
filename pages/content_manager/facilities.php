                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="POST" action="../../function/content_manager/facility_function.php" enctype="multipart/form-data">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item text-dark delete-program"
                                                            href="../../function/content_manager/facility_function.php?facility_id=<?= $facility['facility_id'] ?>"
                                    ...
                                    <div class="modal fade" id="editModal<?= $facility['facility_id'] ?>" tabindex="-1" aria-labelledby="editModalLabel<?= $facility['facility_id'] ?>" aria-hidden="true">
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="../../function/content_manager/facility_function.php" method="POST" enctype="multipart/form-data">
