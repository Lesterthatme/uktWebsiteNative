                                                ...
                                                <div class="carousel-inner">
                                                    <?php foreach ($comlab_images as $index => $image): ?>
                                                        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                                                            ...
                                                            <!-- Trash Icon Button -->
                                                            <form action="../../function/content_manager/comlab_function.php" method="POST"
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body pb-0">
                                        <form method="POST" action="../../function/content_manager/comlab_function.php" enctype="multipart/form-data">
