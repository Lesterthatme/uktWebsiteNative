          ...
          <div class="card-body">
            ...
            <div class="log_container mt-3">
              <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-3">
                ...
                <div class="search-container me-2 mt-1">
                ...
                <div class="d-flex align-items-center ms-md-auto mt-1">
                  ...
                  <div class="float-end">
                    ...
                    <button type="button" class="btn btn-sm rounded-2 px-4 btn-dynamic float-end MT-1" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <table class="table table-hover" id="activityTable" style="width: 100%;">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><span class="status-badge-warning">Pending</span></p>
                      </td>
                      <td>
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item text-success" href="#">Approved</a></li>
                            <li><a class="dropdown-item text-danger" href="#">Deny</a></li>
                          </ul>
                        </div>
                      </td>
                    </tr>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form>
                        ...
                        <div class="mb-3">
                          <label for="message" class="form-label fw-semibold text-muted">Requirements Title:</label>
                          <input type="text" class="form-control" placeholder="Enter Requirements Title">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <label for="message" class="form-label fw-semibold text-muted">Requirements:</label>
                          <textarea class="form-control" id="description" rows="3" placeholder="Enter Requirements" required></textarea>
                        </div>
