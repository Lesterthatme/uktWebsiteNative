...
<body class="bg-light">
        ...
        <div class="card border-0 pb-3">
          <div class="card-body">
            ...
            <div class="log_container mt-3">
              ...
              record_id, 
              archived_at, 
              JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.announcement_image')) AS announcement_image,
              JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.announcement_title')) AS announcement_title,
              JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.announcement_description')) AS announcement_description
            FROM university_archive
            WHERE original_table = 'announcement'
            ORDER BY archived_at DESC";
              ...
              <div class="table-container">
                <table class="table table-hover text-center align-middle" id="activityTable">
                  <thead>
                    <tr>
                      <th class="text-start">Announcement Image</th>
                      <th class="text-start">Announcement Title</th>
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                <td class='text-start'> 
                                  <img src='../../assets/uploads/announcement/" . htmlspecialchars($row['announcement_image']) . "' 
                                  alt='annoucement Image' class='annoucement Image' style='width: 90px; height: 90px; object-fit: cover; border-radius: 10px;'>
                                </td>
                                <td class='text-start'>" . htmlspecialchars($row['announcement_title']) . "</td>
                                 <td class='text-start'>" . htmlspecialchars($row['announcement_description']) . "</td>
                                 <td>
                                    <div class='dropdown'>
                                        ...
                                        <ul class='dropdown-menu'>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/content_manager/restorearchived_function.php?restoreannouncement_id=" . $row['record_id'] . "' 
                                                    onclick='return confirm(\"Do you want to restore this announcement?\")' 
                                                    data-bs-toggle='tooltip' 
                                                    data-bs-placement='right' 
                                                    title='Click here to restore the announcement'>
                                                   <i class='ri-reset-left-line'></i> Restore
                                                </a>
                                            </li>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/content_manager/restorearchived_function.php?deleteannouncement_id=" . $row['record_id'] . "' 
                                                    onclick='return confirm(\"Do you want to delete this announcement?\")' 
                                                    data-bs-toggle='tooltip' 
                                                    data-bs-placement='right' 
                                                    title='Click here to permanent delete the announcement'>
                      ...
                      echo "<tr><td colspan='5'>No archived announcement found</td></tr>";
                    }
                    ?>
                  </tbody>
                </table>
  ...
  <script src="../../assets/bootstrap/js/activeLink.js?v=1.8"></script>
