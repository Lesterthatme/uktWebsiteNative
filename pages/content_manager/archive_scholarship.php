...
<body class="bg-light">
        ...
        <div class="card border-0 pb-3">
          <div class="card-body">
            ...
            <div class="log_container mt-3">
              ...
              record_id, 
              archived_at, 
              JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.scholarship_title')) AS scholarship_title,
            ...
            WHERE original_table = 'university_scholarship'
                ...
                <table class="table table-hover text-center align-middle" id="activityTable">
                  <thead>
                    <tr>
                      ...
                      <th class="text-start">Scholarship Name</th>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                ...
                                <td class='text-start'>" . htmlspecialchars($row['scholarship_title']) . "</td>
                                        ...
                                        <ul class='dropdown-menu'>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/content_manager/restorearchived_function.php?restorescholarship_id=" . $row['record_id'] . "' 
                                                    onclick='return confirm(\"Do you want to restore this scholarship?\")' 
                                                    data-bs-toggle='tooltip' 
                                                    data-bs-placement='right' 
                                                    title='Click here to restore the scholarship'>
                                                    <i class='ri-reset-left-line'></i> Restore
                                                </a>
                                            </li>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/content_manager/restorearchived_function.php?deletescholarship_id=" . $row['record_id'] . "' 
                                                    onclick='return confirm(\"Do you want to delete this scholarship?\")' 
                                                    data-bs-toggle='tooltip' 
                                                    data-bs-placement='right' 
                                                    title='Click here to permanent delete the scholarship'>
                      ...
                      echo "<tr><td colspan='5'>No archived scholarship found</td></tr>";
                    }
                    ?>
                  </tbody>
                </table>
  ...
  <script src="../../assets/bootstrap/js/activeLink.js?v=1.13"></script>
