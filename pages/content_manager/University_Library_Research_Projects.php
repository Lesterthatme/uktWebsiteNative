          ...
          <div class="card-body">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form>
                      ...
                      <div class="mb-3">
                        <label for="message" class="form-label fw-semibold text-muted">Category:</label>
            ...
            <div class="doc-tabs-container mt-3">
              <ul class="doc-tabs d-flex list-unstyled">
                ...
                <li class="me-3">
                  <a class="doc-link active" href="University_Library_Research_Projects.php">Research Projects</a>
                </li>
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center mb-3">
              ...
              Research Project/Thesis involves in-depth study, data collection, and analysis to explore and solve academic or real-world problems, contributing to knowledge in a specific field.
              </p>
            </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row d-flex justify-content-center">
                        <div class="col-md-8">
                          <div class="row">
                              <p><strong>Title:</strong> <span>Sci-Games</span></p>
                              <p><strong>Author:</strong> <span>Ronaldo Payawal</span></p>
                              <p><strong>Category:</strong> <span>Capstone</span></p>
                              <p><strong>Publication Year:</strong> <span>December 2024</span></p>
