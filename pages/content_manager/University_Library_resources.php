...
<body class="bg-light">
          ...
          <div class="card-body">
            ...
            <div class="doc-tabs-container mt-3">
              <ul class="doc-tabs d-flex list-unstyled">
                ...
                <li class="me-3">
                  <a class="doc-link active" href="University_Library_resources.php">Library Resources</a>
                </li>
                <li class="me-3">
                  <a class="doc-link" href="University_Library_operating_hrs.php">Operating Hours</a>
                </li>
                <li class="me-3">
                  <a class="doc-link" href="University_Library_Research_Projects.php">Research Projects</a>
                </li>
  ...
  <script src="../../assets/bootstrap/js/activeLink.js?v=2.2"></script>
