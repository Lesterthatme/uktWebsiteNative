                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="../../function/content_manager/programoffered_function.php" method="POST">
                                                    ...
                                                    <td class="text-center">
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item text-primary view-requirement" href="#"
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item text-danger delete-program"
                                                                        href="../../function/content_manager/programoffered_function.php?program_id=<?= $row['program_id'] ?>"
