          ...
          <div class="card-body">
            ...
            <div class="log_container mt-3">
              ...
              $query =  "SELECT 
                          ...
                          record_id, 
                          archived_at, 
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.h_icon')) AS h_icon,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.h_title')) AS h_title,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.h_description')) AS h_description,
                          JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.h_date')) AS h_date
                      FROM university_archive
                      WHERE original_table = 'highlight'
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr>
                            ...
                            <td>" . htmlspecialchars($row['h_description']) . "</td>
                            <td>" . date("F j, Y", strtotime($row['h_date'])) . "</td>
                            <td>
                                <div class='dropdown'>
                                    ...
                                    <ul class='dropdown-menu'>
                                        <li>
                                            <a class='dropdown-item text-dark' 
                                                href='../../function/content_manager/restorearchived_function.php?restorehighlight_id=" . $row['record_id'] . "' 
                                                onclick='return confirm(\"Do you want to restore this highlight?\")' 
                                                data-bs-toggle='tooltip' 
                                                data-bs-placement='right' 
                                                title='Click here to restore the highlight'>
                                        ...
                                        <li>
                                            <a class='dropdown-item text-dark' 
                                                href='../../function/content_manager/restorearchived_function.php?deletehighlight_id=" . $row['record_id'] . "' 
                                                onclick='return confirm(\"Do you want to delete this highlight?\")' 
                                                data-bs-toggle='tooltip' 
                                                data-bs-placement='right' 
                                                title='Click here to permanent delete the highlight'>
