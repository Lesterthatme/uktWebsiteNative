        ...
        <div class="card border-0 pb-3">
          <div class="card-body">
            ...
            <div class="log_container mt-3">
              ...
              record_id, 
              archived_at, 
              JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.faq_question')) AS faq_question,
              JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.faq_answer')) AS faq_answer,
              JSON_UNQUOTE(JSON_EXTRACT(archive_description, '$.faq_date')) AS faq_date
            FROM university_archive
            WHERE original_table = 'faq'
                  ...
                  <tbody>
                    ...
                    if ($result->num_rows > 0) {
                      while ($row = $result->fetch_assoc()) {
                        echo "<tr>
                                 <td class='text-start'>" . htmlspecialchars($row['faq_question']) . "</td>
                                 <td class='text-start'>" . htmlspecialchars($row['faq_answer']) . "</td>
                                  <td class='text-start'>" . htmlspecialchars($row['faq_date']) . "</td>
                                 <td>
                                    <div class='dropdown'>
                                        ...
                                        <ul class='dropdown-menu'>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/content_manager/restorearchived_function.php?restorefaq_id=" . $row['record_id'] . "' 
                                                    onclick='return confirm(\"Do you want to restore this FAQ?\")' 
                                                    data-bs-toggle='tooltip' 
                                                    data-bs-placement='right' 
                                                    title='Click here to restore the FAQ'>
                                                    <i class='ri-reset-left-line'></i> Restore
                                                </a>
                                            </li>
                                            <li>
                                                <a class='dropdown-item text-dark' 
                                                    href='../../function/content_manager/restorearchived_function.php?deletefaq_id=" . $row['record_id'] . "' 
                                                    onclick='return confirm(\"Do you want to delete this FAQ?\")' 
                                                    data-bs-toggle='tooltip' 
                                                    data-bs-placement='right' 
                                                    title='Click here to permanent delete the FAQ'>
                      ...
                      echo "<tr><td colspan='5'>No archived FAQ found</td></tr>";
                    }
                    ?>
                  </tbody>
                </table>
