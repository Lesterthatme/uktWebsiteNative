                    ...
                    <div class="card-body">
                        <div class="doc-tabs-container mt-3">
                            <ul class="doc-tabs d-flex list-unstyled">
                                <li class="me-3">
                                    <a class="doc-link" href="dean_page">Active</a>
                                </li>
                                <li class="me-3">
                                    <a class="doc-link active" href="dean_pageinactive">Inactive</a>
                                </li>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="../../function/content_manager/dean_function.php" method="POST" enctype="multipart/form-data">
                                            <!-- Upload Image -->
                                            <div class="mb-3">
                        ...
                        WHERE university_dean.status = 'Inactive'";
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="../../function/content_manager/dean_function.php" method="POST"
