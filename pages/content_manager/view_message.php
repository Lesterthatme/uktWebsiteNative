...
if (isset($_GET['message_id'])) {
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        $apQuery = "SELECT ap_id FROM authorized_person WHERE user_id = ?";
        ...
        if ($apRow = $apResult->fetch_assoc()) {
            ...
            if ($updateApStmt->execute()) {
                echo "ap_id updated successfully!";
            } else {
                echo "Error updating ap_id: " . $conn->error;
            }
        } else {
            echo "No authorized_person found for user_id: " . $user_id;
        }
    } else {
                                ...
                                <div class="card shadow-lg border-0">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="replyForm" class="mt-3 p-3 bg-light border rounded" style="display: none;">
                                            <form action="../../function/content_manager/message_function.php" method="POST">
